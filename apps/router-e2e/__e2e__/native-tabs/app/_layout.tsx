...
export default function Layout() {
  ...
  return (
    <ThemeProvider value={scheme === 'dark' ? DarkTheme : DefaultTheme}>
      <NativeTabs rippleColor="#a6c1ee" labelVisibilityMode="labeled">
        ...
        <NativeTabs.Trigger name="nested" rippleColor="#fbc2eb" disableIndicator>
        ...
        <NativeTabs.Trigger name="dynamic" labelVisibilityMode="selected">
          <NativeTabs.Trigger.Icon
            sf="figure.disc.sports"
            md={{
              default: 'sports_hockey',
              selected: 'sports_soccer',
            }}
          />
          <NativeTabs.Trigger.Badge>9</NativeTabs.Trigger.Badge>
          <NativeTabs.Trigger.Label>Dynamic</NativeTabs.Trigger.Label>
        </NativeTabs.Trigger>
        <NativeTabs.Trigger name="icon-test" labelVisibilityMode="unlabeled">
          <NativeTabs.Trigger.Icon
            src={{
              default: require('../../../assets/explore_orange.png'),
